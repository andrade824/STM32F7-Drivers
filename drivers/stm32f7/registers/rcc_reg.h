...
/**
 * Control Register Bit Definitions [5.3.1].
 */
...
/**
 * PLL Configuration Register Bit Definitions [5.3.2].
 */
...
/**
 * Clock Configuration Register Bit Definitions [5.3.3].
 */
...
/**
 * RCC AHB1 Peripheral Clock Register Bit Definitions [5.3.10].
 */
...
/**
 * RCC APB2 Peripheral Clock Register Bit Definitions [5.3.14].
 */
...
/**
 * PLLSAI Configuration Register Bit Definitions [5.3.24].
 */
...
/**
 * Dedicated Clocks Configuration Register 1 Bit Definitions [5.3.25].
 */
BIT_FIELD(RCC_DKCFGR1_PLLI2SDIV,     0, 0x0000001F);
BIT_FIELD(RCC_DKCFGR1_PLLSAIDIVQ,    8, 0x00001F00);
BIT_FIELD(RCC_DKCFGR1_PLLSAIDIVR,   16, 0x00030000);
BIT_FIELD(RCC_DKCFGR1_SAI1SEL,      20, 0x00300000);
BIT_FIELD(RCC_DKCFGR1_SAI2SEL,      22, 0x00C00000);
BIT_FIELD(RCC_DKCFGR1_TIMPRE,       24, 0x01000000);

/**
 * Dedicated Clocks Configuration Register 2 Bit Definitions [5.3.25].
 */
BIT_FIELD(RCC_DKCFGR2_USART1SEL,  0, 0x00000003);
BIT_FIELD(RCC_DKCFGR2_USART2SEL,  2, 0x0000000C);
BIT_FIELD(RCC_DKCFGR2_USART3SEL,  4, 0x00000030);
BIT_FIELD(RCC_DKCFGR2_USART4SEL,  6, 0x000000C0);
BIT_FIELD(RCC_DKCFGR2_USART5SEL,  8, 0x00000300);
BIT_FIELD(RCC_DKCFGR2_USART6SEL, 10, 0x00000C00);
BIT_FIELD(RCC_DKCFGR2_USART7SEL, 12, 0x00003000);
BIT_FIELD(RCC_DKCFGR2_USART8SEL, 14, 0x0000C000);
BIT_FIELD(RCC_DKCFGR2_I2C1SEL,   16, 0x00030000);
BIT_FIELD(RCC_DKCFGR2_I2C2SEL,   18, 0x000C0000);
BIT_FIELD(RCC_DKCFGR2_I2C3SEL,   20, 0x00300000);
BIT_FIELD(RCC_DKCFGR2_I2C4SEL,   22, 0x00C00000);
BIT_FIELD(RCC_DKCFGR2_LPTIM1SEL, 24, 0x03000000);
BIT_FIELD(RCC_DKCFGR2_CECSEL,    26, 0x04000000);
BIT_FIELD(RCC_DKCFGR2_CK48MSEL,  27, 0x08000000);
BIT_FIELD(RCC_DKCFGR2_SDMMC1SEL, 28, 0x10000000);
