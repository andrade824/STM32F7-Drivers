 ...
 * @created 8/9/2018
 *
 * Chrom-ART Accelerator (Graphics DMA) Controller Register Map.
 */
#pragma once
...
typedef enum {
	DMA2D_AM_NO_MOD = 0x0,
	DMA2D_AM_REPLACE = 0x1,
	DMA2D_AM_REPLACE_MULT = 0x2,
} Dma2DAlphaModes;
...
/* MA2D Background PFC Control Register Bit Definitions. */
