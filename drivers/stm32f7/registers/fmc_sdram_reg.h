...
typedef enum {
	SDRAM_SDCMR_NORMAL        = 0x0,
	SDRAM_SDCMR_CLOCK_CFG     = 0x1,
	SDRAM_SDCMR_PALL          = 0x2,
	SDRAM_SDCMR_AUTO_REFRESH  = 0x3,
	SDRAM_SDCMR_LOAD_MODE_REG = 0x4,
	SDRAM_SDCMR_SELF_REFRESH  = 0x5,
	SDRAM_SDCMR_POWER_DOWN    = 0x6
} SdramSdcmrMode;

/* DRAM Refresh Timer Register Bit Definitions. */
