...
#define LCD_CONFIG_HSYNC_POL  LCD_POL_ACTIVE_LOW
#define LCD_CONFIG_VSYNC_POL  LCD_POL_ACTIVE_LOW
#define LCD_CONFIG_DE_POL     LCD_POL_ACTIVE_LOW
#define LCD_CONFIG_CLK_POL    LCD_POL_ACTIVE_LOW
